CREATE TABLE IF NOT EXISTS `STUDENT_STATE` (
  ...
  `userName` varchar(50) NOT NULL DEFAULT '' COMMENT 'Empty string means that this is a section-wide model.  Otherwise, should match userName in PROBLEM_ATTEMPT',
