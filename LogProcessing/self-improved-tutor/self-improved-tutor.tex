...
UW Platteville, 118 students, winter of 2012.  Tutor randomly chooses
policy: 
\begin{enumerate} 
...
Run at St. Anselm College May-July 2012, 14 students, for entire
two-semester course.  
...
the control condition.  Thus, the experimental design is a mixed factorial design.
...
condition.  Since the Akaike weights  give us the probability that learning occurred
at step $j$, we then can find the probability the learning occurred
