...
<html>
  <head>
    <STYLE type="text/css"> OL.withroman { list-style-type: lower-alpha } </STYLE>
...
<table border=1>
	...
	<tr>
        <td align=left width=200>a) Electric Fields</td>
	...
	<tr>
        <td align=left width=200>b) Potential</td>
	...
	<tr>
        <td align=left width=200>c) Capacitors</td>
	...
	<tr>
        <td align=left width=200>d) Resistors</td>
	...
	<tr>
        <td align=left width=200>e) DC Circuits</td>
	...
	<tr>
        <td align=left width=200>f) RC, Lr and LCR circuits</td>
	...
	<tr>
        <td align=left width=200>g) Magnetic Forces</td>
	...
	<tr>
        <td align=left width=200>h) Faraday's Law</td>
	...
	<tr>
        <td align=left width=200>i) Inductors</td>
	...
	<tr>
        <td align=left width=200>j) Geometical Optics</td>
	...
	<tr>
        <td align=left width=200>k) Wave Optics</td>
