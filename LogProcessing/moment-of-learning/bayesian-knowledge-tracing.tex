...
The first form is the Bayesian Knowledge Tracing {\em model} which is a 
model that predicts the probability of correct application of a skill 
as a function of time and the model parameters.  
%This model can be fit to student prerformance data to determine model
%parameters.  
It is commonly expressed as a Hidden Markov Model.
