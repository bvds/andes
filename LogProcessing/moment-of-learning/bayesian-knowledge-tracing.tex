...
\end{eqnarray}
%
If we choose parameters consistant with negative learning,
$P(S)+P(G)>1$, we find that $P(L_j)$ becomes inverted: $P(L_j)$ 
decreases for correct steps and increases for incorrect steps.
