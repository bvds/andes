...
%
%  There is a bug in Zotero with exporting of ampersands to BibTeX.
%  See  http://forums.zotero.org/discussion/27422/ampersands-in-bibtex-export
%  As a work-around, replace '\$0' with '\&' in the file education-modelling.bib
%
