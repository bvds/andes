...
For the student dataset $\mathcal{A}$, we obtain $Q=0.047\pm0.008$, which
...
\bibitem{kc}Reference with definition of KC.

\bibitem{its}Kurt meta-analysis of tutor systems vs. human tutors.
...
\bibitem{bgh} Baker, R., Goldstein, A., Heffernan, N., Detecting
 the Moment of Learning, ITS 2010.
