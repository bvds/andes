...
<table border=1 width="100%">
    <tr><th>Turn</th><th>Action</th><th>Old Response</th><th>New Response</th></tr>
<?php
	     // POST filtered set of tranactions to server in
	     // chronological order.
	     //
	     //  Clear test database:
	     //    use andes_test;
...
while ($myrow = mysql_fetch_array($result)) {
  ...
  if($loadFailed{$clienID} && in_array($method,$methods) && 
