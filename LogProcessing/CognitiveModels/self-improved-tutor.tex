...
%
%  This is not really needed below
...
\item[fracSectionFlounderTime] Flounder time is the time spent between 
...
transaction is found.  {\em fracSectionFlounderTime} is the flounder
