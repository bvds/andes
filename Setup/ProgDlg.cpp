...
CProgressDlg1::CProgressDlg1(UINT nCaptionID)
{
    ...
    m_nUpper=100;
    m_nStep=1;
    //{{AFX_DATA_INIT(CProgressDlg1)
    // NOTE: the ClassWizard will add member initialization here
    //}}AFX_DATA_INIT
    m_bParentDisabled = FALSE;
}

CProgressDlg1::~CProgressDlg1()
{
    if(m_hWnd!=NULL)
      DestroyWindow();
}

BOOL CProgressDlg1::DestroyWindow()
{
    ReEnableParent();
    return CDialog::DestroyWindow();
}

void CProgressDlg1::ReEnableParent()
{
...
BOOL CProgressDlg1::Create(CWnd *pParent)
{
    ...
    if(!CDialog::Create(CProgressDlg1::IDD,pParent))
    {
      ReEnableParent();
      return FALSE;
    }
...
void CProgressDlg1::DoDataExchange(CDataExchange* pDX)
{
    CDialog::DoDataExchange(pDX);
    //{{AFX_DATA_MAP(CProgressDlg1)
    DDX_Control(pDX, CG_IDC_PROGDLG_PROGRESS, m_Progress);
    //}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CProgressDlg1, CDialog)
    //{{AFX_MSG_MAP(CProgressDlg1)
    //}}AFX_MSG_MAP
END_MESSAGE_MAP()

void CProgressDlg1::SetStatus(LPCTSTR lpszMessage)
{
...
void CProgressDlg1::OnCancel()
{
    m_bCancel=TRUE;
}

void CProgressDlg1::SetRange(int nLower,int nUpper)
{
    m_nLower = nLower;
    m_nUpper = nUpper;
...
int CProgressDlg1::SetPos(int nPos)
{
    PumpMessages();
...
int CProgressDlg1::SetStep(int nStep)
{
    m_nStep = nStep; // Store for later use in calculating percentage
    return m_Progress.SetStep(nStep);
}

int CProgressDlg1::OffsetPos(int nPos)
{
    PumpMessages();
...
void CProgressDlg1::PumpMessages()
{
...
BOOL CProgressDlg1::CheckCancelButton()
{
...
void CProgressDlg1::UpdatePercent(int nNewPos)
{
...
/////////////////////////////////////////////////////////////////////////////
// CProgressDlg1 message handlers

BOOL CProgressDlg1::OnInitDialog() 
{
