...
define([
    ...
    "dojo/_base/declare",
],function(dom, domStyle, array, ColorPalette, popup, registry, connect, declare){
    ...
    return declare(null,{
        ...
        constructor: function(){
            ...
            for(nm in this.userWidgets){
                this[nm] = registry.byId(this.userWidgets[nm]);
            }
            for(nm in this.userVisuals){
                this[nm] = dom.byId(this.userVisuals[nm]);
            }
            ...
            domStyle.set(this.correct, "background", window.myDrawing.defaults.correct.color);
            domStyle.set(this.incorrect, "background", window.myDrawing.defaults.incorrect.color);

            this.picker = new ColorPalette({
                id:"picker",
                open:false,
            ...
            this.connectMult([
                ...
                [this.dialog, "onHide", this, function(){
                    if(this.picker.open) this.picker.onCancel();
                }]
            ]);
        },

        connectMult: function(c){
            array.forEach(c, function(o){
        ...
        _setColor: function(node, name, val){
            ...
            domStyle.set(node, "background", o.color);
