...
dojo.declare("drawing.manager.Anchors", null, {
	// summary:
	...
	//			to the point.
	constructor: function(/* dojox.__stencilArgs */options){
...
dojo.declare("drawing.manager.Anchor", null, {
	// summary:
	...
	onAnchorDrag: function(/*manager.__mouseObj*/obj){
		// summary:
		//		Event fires for dragging of on anchor
		if(this.selected){
