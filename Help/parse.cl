...
;; NOTE: if parse quits and remainder is not empty the the beginning of rem indicates the
;;  point of failure
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; support routine returns the lhs of the tree portion of the parse struct passed in parse
...
(defun parse-get-valid (root parses)
  (find-all-if #'(lambda (x) (equal root (car x))) parses :key #'parse-tree))
;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defun parse-get-complete (parses)
  (find-all-if #'(lambda (x) (= 0 (length x))) parses :key #'parse-rem))
;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
