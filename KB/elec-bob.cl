(defproblem elec1a
  ...
  :soughts (
    (mag (field region electric unspecified))
  )
)
...
(defproblem elec1b ;not working for charge as sought; see Bug #673
  ...
  :givens(
    ...
    (given (dir (force particle unspecified electric :time 1))
      (dnum 195 |deg|))
    (given (mag (field region electric unspecified)) (dnum 16.2 |N/C|))
...
(defproblem elec3a ;version for bob's experiment
  ...
  :givens (
    ...
    (motion electron straight :accel (dnum 90 |deg|) :dir (dnum 90 |deg|) :time (during 1 2) )
    (motion electron straight :accel unknown :dir (dnum 90 |deg|) :time 2)      
...
(defproblem elec4a ;version for bob's experiment
  ...
  :givens (
    ...
    (motion proton straight :accel (dnum 0 |deg|) :dir (dnum 0 |deg|) :time (during 1 2))
    (motion proton straight :dir (dnum 0 |deg|) :time 2)      
...
(defproblem elec5a ;version for bob's experiment
  ...
  :givens (
    ...
    ;; Kinematics (rectilinear)
    (motion proton momentarily-at-rest :time 1)
    (motion proton straight :accel (dnum 180 |deg|) :dir (dnum 180 |deg|) :time (during 1 2))
    (motion proton straight :dir (dnum 180 |deg|) :time 2)      
...
(defproblem elec6a ;version for bob's experiment
  ...
  :givens (
    ...
    (motion electron straight :dir (dnum 90 |deg|) :time 1)
    (motion electron straight :accel (dnum 270 |deg|) :dir (dnum 90 |deg|) :time (during 1 2))
...
;;   (given (compo y 0 (field region electric unspecified)) (dnum 3.0E4 |N/C|))
    (given (mag (field region electric unspecified))
      (dnum 3.6055512754639892931192212674705 |N/C|))
    (given (dir (field region electric unspecified))
