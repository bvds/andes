...
; AW: Added. This is required for compiling code using random-state objects,
; such as code generated by random macro with constant arguments.
(defmethod make-load-form ((x random-state) &optional env)
	  (declare (ignore env))
