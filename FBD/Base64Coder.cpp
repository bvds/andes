...
// static const char chPad = '=';
// AW: change to variant chars and padCh -- so not standard base 64!!
static char	Base64Digits[] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789[]";
static const char chPad = '|';
...
DWORD Base64Coder::DecodedLength() const 
{ 
	return m_nDDataLen;
}
...
{  // Initialize Decoding table.
	...
	Base64Coder::m_DecodeTable[chPad]				= -1;
	Base64Coder::m_DecodeTable[chPad|0x80]		= -1;
