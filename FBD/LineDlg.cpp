...
CLineDlg::CLineDlg(CDrawObj*pObj,  CWnd* pParent /*=NULL*/)
	: CDrawObjDlg(CLineDlg::IDD, pObj, pParent)
{
...
BEGIN_CTL_TBL(CLineDlg)
	...
	"OK",			IDOK,
	"Cancel",		IDCANCEL,
END_CTL_TBL(CLineDlg)


BEGIN_MESSAGE_MAP(CLineDlg, CDrawObjDlg)
...
void CLineDlg::InitObjectDlg()
{
	CGuideLine* pVec = (CGuideLine*) m_pTempObj;
...
void CLineDlg::UpdateTempVector()
{
	 CGuideLine* pTempVec = (CGuideLine*) m_pTempObj;
...
void CLineDlg::UpdateTempVariable()
{
	...
	pTempVar->m_strDef =  CString("line direction")
