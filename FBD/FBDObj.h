...
#define VECTOR_MOMENTUM		5
#define VECTOR_POSITION		6
#define VECTOR_TORQUE		7
#define VECTOR_RELVEL       8
#define VECTOR_EFIELD       9
#define VECTOR_BFIELD       10
#define VECTYPE_LAST		VECTOR_BFIELD
