...
;; This is mostly for Sung-Young's project.  see also sbclrc-sample
;; Ugly code duplication with respect to andes-help (should be fixed).
(defsystem :andes-help-core
  :name "Andes help core"
  :description "Andes physics tutor system: helpsystem"
  :depends-on (problems)
  :components (
	       (:module "Base"
